...
void Cpu::Clock(GameBoy& gb)
{
	...
	switch (*opcode)
	{
		...
		*********************************************************************************************/
		...
		case 0x27: { unimplementedInstruction(state, *opcode); }
		case 0x37: { unimplementedInstruction(state, *opcode); }
		case 0x76: { unimplementedInstruction(state, *opcode); }
		...
		case 0xFB: { unimplementedInstruction(state, *opcode); }
		...
		*********************************************************************************************/
		...
		case 0x18: { unimplementedInstruction(state, *opcode); }
		...
		case 0x28: { unimplementedInstruction(state, *opcode); }
		case 0x30: { unimplementedInstruction(state, *opcode); }
		...
		case 0xC0: { unimplementedInstruction(state, *opcode); }
		case 0xC2: { unimplementedInstruction(state, *opcode); }
		...
		case 0xC4: { unimplementedInstruction(state, *opcode); }
		case 0xC7: { unimplementedInstruction(state, *opcode); }
		case 0xC8: { unimplementedInstruction(state, *opcode); }
		case 0xC9: { unimplementedInstruction(state, *opcode); }
		case 0xCA: { unimplementedInstruction(state, *opcode); }
		case 0xCC: { unimplementedInstruction(state, *opcode); }
		case 0xCD: { unimplementedInstruction(state, *opcode); }
		case 0xCF: { unimplementedInstruction(state, *opcode); }
		case 0xD0: { unimplementedInstruction(state, *opcode); }
		case 0xD2: { unimplementedInstruction(state, *opcode); }
		case 0xD4: { unimplementedInstruction(state, *opcode); }
		case 0xD7: { unimplementedInstruction(state, *opcode); }
		case 0xD8: { unimplementedInstruction(state, *opcode); }
		case 0xD9: { unimplementedInstruction(state, *opcode); }
		case 0xDA: { unimplementedInstruction(state, *opcode); }
		case 0xDC: { unimplementedInstruction(state, *opcode); }
		case 0xDF: { unimplementedInstruction(state, *opcode); }
		case 0xE7: { unimplementedInstruction(state, *opcode); }
		case 0xE9: { unimplementedInstruction(state, *opcode); }
		case 0xEF: { unimplementedInstruction(state, *opcode); }
		case 0xF7: { unimplementedInstruction(state, *opcode); }
		...
		*********************************************************************************************/
		...
		case 0x0A: { unimplementedInstruction(state, *opcode); }
		...
		case 0x40: { unimplementedInstruction(state, *opcode); }
		case 0x41: { unimplementedInstruction(state, *opcode); }
		case 0x42: { unimplementedInstruction(state, *opcode); }
		case 0x43: { unimplementedInstruction(state, *opcode); }
		case 0x44: { unimplementedInstruction(state, *opcode); }
		case 0x45: { unimplementedInstruction(state, *opcode); }
		case 0x46: { unimplementedInstruction(state, *opcode); }
		case 0x47: { unimplementedInstruction(state, *opcode); }
		case 0x48: { unimplementedInstruction(state, *opcode); }
		case 0x49: { unimplementedInstruction(state, *opcode); }
		case 0x4A: { unimplementedInstruction(state, *opcode); }
		case 0x4B: { unimplementedInstruction(state, *opcode); }
		case 0x4C: { unimplementedInstruction(state, *opcode); }
		case 0x4D: { unimplementedInstruction(state, *opcode); }
		case 0x4E: { unimplementedInstruction(state, *opcode); }
		case 0x4F: { unimplementedInstruction(state, *opcode); }

		case 0x50: { unimplementedInstruction(state, *opcode); }
		case 0x51: { unimplementedInstruction(state, *opcode); }
		case 0x52: { unimplementedInstruction(state, *opcode); }
		case 0x53: { unimplementedInstruction(state, *opcode); }
		case 0x54: { unimplementedInstruction(state, *opcode); }
		case 0x55: { unimplementedInstruction(state, *opcode); }
		case 0x56: { unimplementedInstruction(state, *opcode); }
		case 0x57: { unimplementedInstruction(state, *opcode); }
		case 0x58: { unimplementedInstruction(state, *opcode); }
		case 0x59: { unimplementedInstruction(state, *opcode); }
		case 0x5A: { unimplementedInstruction(state, *opcode); }
		case 0x5B: { unimplementedInstruction(state, *opcode); }
		case 0x5C: { unimplementedInstruction(state, *opcode); }
		case 0x5D: { unimplementedInstruction(state, *opcode); }
		case 0x5E: { unimplementedInstruction(state, *opcode); }
		case 0x5F: { unimplementedInstruction(state, *opcode); }

		case 0x60: { unimplementedInstruction(state, *opcode); }
		case 0x61: { unimplementedInstruction(state, *opcode); }
		case 0x62: { unimplementedInstruction(state, *opcode); }
		case 0x63: { unimplementedInstruction(state, *opcode); }
		case 0x64: { unimplementedInstruction(state, *opcode); }
		case 0x65: { unimplementedInstruction(state, *opcode); }
		case 0x66: { unimplementedInstruction(state, *opcode); }
		case 0x67: { unimplementedInstruction(state, *opcode); }
		case 0x68: { unimplementedInstruction(state, *opcode); }
		case 0x69: { unimplementedInstruction(state, *opcode); }
		case 0x6A: { unimplementedInstruction(state, *opcode); }
		case 0x6B: { unimplementedInstruction(state, *opcode); }
		case 0x6C: { unimplementedInstruction(state, *opcode); }
		case 0x6D: { unimplementedInstruction(state, *opcode); }
		case 0x6E: { unimplementedInstruction(state, *opcode); }
		case 0x6F: { unimplementedInstruction(state, *opcode); }

		case 0x70: { unimplementedInstruction(state, *opcode); }
		case 0x71: { unimplementedInstruction(state, *opcode); }
		case 0x72: { unimplementedInstruction(state, *opcode); }
		case 0x73: { unimplementedInstruction(state, *opcode); }
		case 0x74: { unimplementedInstruction(state, *opcode); }
		case 0x75: { unimplementedInstruction(state, *opcode); }
		case 0x77: { unimplementedInstruction(state, *opcode); }
		case 0x78: { unimplementedInstruction(state, *opcode); }
		case 0x79: { unimplementedInstruction(state, *opcode); }
		case 0x7A: { unimplementedInstruction(state, *opcode); }
		case 0x7B: { unimplementedInstruction(state, *opcode); }
		case 0x7C: { unimplementedInstruction(state, *opcode); }
		case 0x7D: { unimplementedInstruction(state, *opcode); }
		case 0x7E: { unimplementedInstruction(state, *opcode); }
		...
		*********************************************************************************************/
		...
		case 0x31: { unimplementedInstruction(state, *opcode); }
		case 0xC1: { unimplementedInstruction(state, *opcode); }
		case 0xC5: { unimplementedInstruction(state, *opcode); }
		case 0xD1: { unimplementedInstruction(state, *opcode); }
		case 0xD5: { unimplementedInstruction(state, *opcode); }
		case 0xE1: { unimplementedInstruction(state, *opcode); }
		case 0xE5: { unimplementedInstruction(state, *opcode); }
		case 0xF1: { unimplementedInstruction(state, *opcode); }
		case 0xF5: { unimplementedInstruction(state, *opcode); }
		case 0xF8: { unimplementedInstruction(state, *opcode); }
